...
- **Weather service** (stubbed in Phase 1)
  - MySQL-backed weather APIs (implementation planned)
...
### Weather (Phase 1 stubs)

- `GET /api/v1/weather/current/` – returns 501 Not Implemented
- `GET /api/v1/weather/daily/` – returns 501 Not Implemented
- `GET /api/v1/weather/weekly/` – returns 501 Not Implemented
